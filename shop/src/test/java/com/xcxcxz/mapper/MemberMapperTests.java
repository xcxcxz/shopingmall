...
public class MemberMapperTests {
	...
	// 회원가입 쿼리 테스트 메서드
	  ...
	  member.setMemberAddr1("test"); //회원 우편번호 member.setMemberAddr2("test"); //회원주소 
	 ...
	 * 
	 * 올바른 아이디 비번 입력경우 member.setMemberId("test1"); member.setMemberPw("test1");
	 * 
	 * 올바른 않은 아이디 비번 입력경우 //member.setMemberId("test1123");
	 * //member.setMemberPw("test1321321");
	 * 
	 * membermapper.memberLogin(member); System.out.println("결과 값 : " +
