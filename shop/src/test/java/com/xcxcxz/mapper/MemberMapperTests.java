...
public class MemberMapperTests {
	...
	@Autowired private MemberMapper membermapper; // MemberMapper.java 인터페이스 의존성
	 /* 주입
	 * 
	 * // 회원가입 쿼리 테스트 메서드
	 * 
	 ...
	 * member.setMemberAddr1("test"); //회원 우편번호 member.setMemberAddr2("test");
	 * //회원주소 member.setMemberAddr3("test"); //회원 상세주소
	 * 
